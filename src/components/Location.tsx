        ...
        <div className="container location-grid">
          <div>
            ...
            <p className="prose">
              ...
              Московской области, ориентировочно в 35 км от МКАД. При нормальной
              дорожной ситуации дорога занимает примерно 35–40 минут на
              автомобиле. Это позволяет совместить загородный формат жизни с
              регулярными поездками в Москву.
            </p>
