...
const rows = [
  ...
  { label: "Реконструкция", value: String(property.reconstructionYear) },
  { label: "Материал", value: "пеноблок / кирпич / монолит" },
  { label: "Коммуникации", value: property.communications },
  { label: "Теплый пол", value: property.underfloorHeating },
  { label: "Котельная", value: property.boilers },
  { label: "Гараж", value: "есть, требует завершения работ" },
  { label: "Помещение под сауну", value: "есть, требует завершения работ" },
  { label: "Сигнализация", value: property.alarm },
