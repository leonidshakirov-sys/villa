  ...
  locationImages: [
    {
      ...
      alt: "Торговый центр Русь рядом с Житнево: Пятёрочка, Wildberries и Ozon",
      category: "shops",
      categoryLabel: "ТЦ Русь",
      width: 1920,
      height: 1180,
      available: true,
    },
    {
      ...
      alt: "Пятёрочка, ВкусВилл и ВинЛаб рядом с домом в Житнево",
      category: "shops",
    ...
    {
      id: "playground-01",
      src: "/images/location/location-playground-01.webp",
      alt: "Детская площадка рядом с деревней Житнево",
      category: "playground",
      categoryLabel: "Детская площадка рядом",
      width: 1920,
      height: 1440,
      available: true,
    },
